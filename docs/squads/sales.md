...
| Skill | What it does |
|-------|--------------|
| `/outbound` | Signal-based prospecting: ICP definition, trigger events, multi-channel sequences, personalized templates. |
| `/discovery-prep` | Prepare for discovery calls using SPIN, Gap Selling, or Sandler. Question frameworks and call outlines. |
| `/deal-strategy` | MEDDPICC qualification scoring. Expose pipeline risk, build win plans, competitive positioning. |
